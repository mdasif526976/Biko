...
const Review = () => {
  return (
    <div className="my-8 py-4 px-5">
      <h1 className="p-4 text-4xl font-semibold text-center">
        What our customers are saying about us
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 ">
        <div className="flex flex-col max-w-sm mx-4 my-6 shadow-2xl rounded-xl">
          <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-900">
            <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-100">
              ...
              Biko is very user Friendly,I find here best quality Product.
              Seller and Admin Very help me to Choose my bike.
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                fill="currentColor"
        ...
        <div className="flex flex-col max-w-sm mx-4 my-6 shadow-2xl rounded-xl">
          <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-900">
            <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-100">
              ...
              Biko is very user Friendly,I find here best quality Product.
              Seller and Admin Very help me to Choose my Scoter.
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                fill="currentColor"
        ...
        <div className="flex flex-col max-w-sm mx-4 my-6 shadow-2xl rounded-xl">
          <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 dark:bg-gray-900">
            <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-100">
              ...
              Biko is very user Friendly,I find here best quality Product.
              Seller and Admin Very help me to Choose my Sports-Bike.
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                fill="currentColor"
